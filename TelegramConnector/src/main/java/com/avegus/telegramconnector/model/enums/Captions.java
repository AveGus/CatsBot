...
public class Captions {
    ...
    public static final String FAKE_CAT = "Представьте что это котик. У него %d лайков и %d дизлайков";
    ...
    public static final String PHOTO_UPLOAD_DECISION = "Красивая киска, cохраняю?";
